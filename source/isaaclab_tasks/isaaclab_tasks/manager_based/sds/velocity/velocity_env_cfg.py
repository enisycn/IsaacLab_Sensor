...
# Use SDS-specific MDP functions (currently using locomotion MDP)
import isaaclab_tasks.manager_based.sds.velocity.mdp as mdp
...
@configclass
class CommandsCfg:
    """Command specifications for the SDS MDP."""
